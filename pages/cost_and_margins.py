...
edited_df = st.data_editor(st.session_state.df_pour_affichage, use_container_width=True, num_rows="dynamic")

# --- 5. CALCULS ET SAUVEGARDE ---
if st.button("🚀 Enregistrer et Générer le Bilan"):
